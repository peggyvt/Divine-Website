...
<html>
    ...
    <body>
        ...
        <div align="center">
            ...
            <div class="row">
                    <?php 
                        $cursor = $collection_products->find(array('collection' => 'SILHOUETTE'));
                        foreach ($cursor as $product) {
                            echo'<div class="col-md-3">
                            <button style="background-color: white; border: none; outline: none;" type="button" data-toggle="modal" data-target="#silhouette-Modal-' . $product->_id . '"><img class="img-fluid w-100 img" src="' . $product->img . '" size="50%" alt="candle image"></button>
                            ...
                            <!--ITEM MODAL-->
                            <div class="modal" id="silhouette-Modal-' . $product->_id . '">
                                        ...
                                        <section class="product-information" text-align="center">
                                            ...
                                            <div class="info">
                                                <form method="POST" action="add-product-somewhere.php">
                                                    ...
                                                    <input style="white-space: pre-wrap; border: none; width: 250px;" type="text" id="name" name="name" value="' . $product->name . '" readonly><br>

                                                    <label class="price-label" for="price">Price: </label>
                                                    <input type="text" id="price" style="border: none; width: 30px;" name="price" value="' . $product->price . '" readonly><span style="font-weight: 100;">&euro;</span><br> 

                                                    <label class="availability-label" for="availability">Availability: </label>
                                                    <input type="text" id="availability" style="border: none; width: 30px;" name="availability" value="' . $product->availability . '" readonly> <span style="font-weight: 100;"> items left</span><br>
