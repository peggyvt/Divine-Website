...
<html>
    ...
    <body>
        ...
        $results = $collection_products->find( ['$or' => [
        ['name' => ['$regex' => new MongoDB\BSON\Regex($search, "i")]], 
        ['collection' => ['$regex' => new MongoDB\BSON\Regex($search, "i")]]
        ] ]);?>
        
        <div class="msg">
            <?php echo "Searching for: " . $search;?>
        </div>
        ...
        <div class="container myCont3">
            <div class="row">
                <?php foreach ($results as $product) { ?>    
                    <div class="col-md-3">
                        <img class="img-fluid w-100 img" src="<?php echo $product->img;?>" size="50%" alt="candle image">
